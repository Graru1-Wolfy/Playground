...
Direct: [bounce-check-v1.0.4.apk](https://github.com/Graru1-Wolfy/Playground/releases/download/bounce-check-v1.0.4/bounce-check-v1.0.4.apk)
...
App id: `com.playground.bouncecheck` · launcher name: **Bounce Check** · version **1.0.4**
