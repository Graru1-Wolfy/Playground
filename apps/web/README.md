...
Direct: [bounce-check-v1.0.3.apk](https://github.com/Graru1-Wolfy/Playground/releases/download/bounce-check-v1.0.3/bounce-check-v1.0.3.apk)
...
App id: `com.playground.bouncecheck` · launcher name: **Bounce Check** · version **1.0.3**
