...
- **[Cursor Cloud Agents + Acode](./docs/cursor-cloud-acode.md)** — the
...
- **[Experimental native Cursor Agent + Termux:X11 installer](./scripts/setup-termux-x11-cursor.sh)**
  — a separate, unsupported compatibility path for running the Cursor Agent
  CLI and an optional Linux desktop in native Termux.
