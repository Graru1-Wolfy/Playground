...
export const DEFAULT_START_GUIDES: DefaultStartGuide[] = [
  {
    ...
    instructions: ["Hold +walk over the drop.", "Uncrouched landing."],
  },
  {
    label: "Crouch Walk",
    movement: MOVEMENT_BINDS[1]!,
    action: ACTION_BINDS[1]!,
    instructions: ["Hold +walk and stay crouched over the drop.", "Crouched landing."],
  },
  {
    label: "Jump",
    movement: MOVEMENT_BINDS[1]!,
    action: ACTION_BINDS[2]!,
    instructions: ["Press +strike at the edge for jump shoot.", "Uncrouched landing."],
  },
  {
    label: "Crouch Jump",
    movement: MOVEMENT_BINDS[1]!,
    action: ACTION_BINDS[3]!,
    instructions: ["Press +strike at the edge for jump duck shoot.", "Crouched landing."],
  },
  {
    label: "Ctap",
    movement: MOVEMENT_BINDS[1]!,
    action: ACTION_BINDS[4]!,
    instructions: ["Press +strike at the edge for CTAP jump duck shoot.", "Crouched landing."],
  },
  {
    label: "Ceilingsmash",
    movement: MOVEMENT_BINDS[1]!,
    action: ACTION_BINDS[0]!,
    instructions: ["Use ceiling gap height for the check.", "Walk or drop under the ceiling target."],
  },
];
